function output = NIRAvector(inputs)
% This solves NIRA where some constants are vectors. Designed to be used
...
[variables, c, l, exitflag, t, customfunctions] = solveNIRA(); % solve!
